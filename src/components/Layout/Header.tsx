      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="flex md:hidden items-center">
            ...
            <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="inline-flex items-center justify-center p-2 rounded-md text-gray-900 hover:text-primary">
      ...
      {mobileMenuOpen && <div className="md:hidden bg-white shadow-lg">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            {isAuthenticated() ? <div>
                ...
                <button onClick={handleLogout} className="w-full text-left flex items-center px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-100">
                  <LogOut className="h-5 w-5 mr-2" /> Logout
                </button>
              </div> : <div className="space-y-2 px-3 py-2">
                <Link to="/login" className="block w-full py-2 px-3 text-center rounded-md bg-gray-100 font-medium text-gray-900 hover:bg-gray-200" onClick={() => setMobileMenuOpen(false)}>
                  Login
                </Link>
                <Link to="/register" className="block w-full py-2 px-3 text-center rounded-md bg-primary font-medium text-black hover:bg-primary/90" onClick={() => setMobileMenuOpen(false)}>
                  Register
                </Link>
              </div>}
          </div>
